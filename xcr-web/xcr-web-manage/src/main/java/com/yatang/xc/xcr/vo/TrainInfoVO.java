...
public class TrainInfoVO implements Serializable {
	...
	public String toString() {
		return "TrainInfoDTO [id=" + id + ", name=" + name + ", content=" + content + ", trainLength=" + trainLength
				+ ", icon=" + icon + ", status=" + status + ", viedioUrl=" + viedioUrl + ", imagesUrl=" + imagesUrl
				+ ", fileUrl=" + fileUrl + ", remark=" + remark + ", createUid=" + createUid + ", createTime="
				+ createTime + ", modifyUid=" + modifyUid + ", modifyTime=" + modifyTime + ", releasesTime="
				+ releasesTime + "]";
	}
