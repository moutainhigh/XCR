var win = new function () {
    ...
    this.confirm = function (title, message, selected) {
        ...
        var html = '<div class="win"><div class="mask-layer"></div><div class="window-panel"><iframe class="title-panel" frameborder="0" marginheight="0" marginwidth="0" scrolling="no"></iframe><div class="title"><h3></h3></div><a href="javascript:void(0)" onclick="win._close(false);" class="close-btn" title="关闭">×</a><div class="body-panel"><p class="content"></p><p class="btns" style="margin-left:100px;margin-top: 50px;"><button class="btn btn-primary" style="margin-right:20px;" tabindex="1" onclick="win._close(true);">确定</button><button class="btn btn-default" onclick="win._close(false);">取消</button></p></div></div></div>';
