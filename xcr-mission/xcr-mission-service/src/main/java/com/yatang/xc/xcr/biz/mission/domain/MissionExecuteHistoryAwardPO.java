...
public class MissionExecuteHistoryAwardPO implements Serializable {

    /**
     * @Fields serialVersionUID : TODO 变量名称
     */
    private static final long serialVersionUID = -7061408535854847999L;


    @Override
    public String toString() {
        return "MissionExecuteHistoryAwardPO [id=" + id + ", missonExecuteIdInfoId=" + missonExecuteIdInfoId + ", awardType=" + awardType + ", grantStyle="
